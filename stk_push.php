...
if (isset($_POST['submit'])) {
    ...
    $CallbackURL = 'https://wicked-cows-bathe.loca.lt'; // Replace with your actual sandbox callback URL
    ...
    try {
        ...
        // Log the STK Push response to a file
        file_put_contents('stk_push_response.log', $response . PHP_EOL, FILE_APPEND);

        echo "STK Push Request Successful:\n";
        echo $response;
    } catch (Exception $e) {
        // Log the error to the file as well
        file_put_contents('stk_push_response.log', 'Error: ' . $e->getMessage() . PHP_EOL, FILE_APPEND);
